...
public class WorkoutManager {
    ...
    public void editOrDeleteWorkoutEntry(int workoutId, String action, String newType, int newDuration, int newCalories, String newNotes) {
        ...
        recalculateDashboard(target.getUserId());
    }
