...
public class SocialsPage extends JFrame {
    private user u;
    private MySQLDatabaseConnector db;

    public SocialsPage(user u,  MySQLDatabaseConnector db) {
        this.u = u;
        this.db = db;

        // Apply shared defaults
        defaultSettings.setDefault(this);
        setTitle("OsoFit — Socials Page");
        ...
        JLabel title = new JLabel("Socials", SwingConstants.CENTER);
